...
public abstract class SecurityAssetType<T extends Asset> extends AssetType<T> {
	...
	public static final AssetType<LittlePrincipal> PRINCIPAL    = new AssetType<LittlePrincipal> (
		...
		public AssetSpecializer getSpecializer () { return getAccountManager (); }
	...
	public static final AssetType<LittleUser> USER    = new AssetType<LittleUser> (
		...
		public LittleUser create () throws FactoryException { return new SimpleUser (); }
		public boolean mustBeAdminToCreate () { return true; }
        @Override
	...
	public static final AssetType<LittleGroup> GROUP    = new AssetType<LittleGroup> (
		...
		public LittleGroup create () throws FactoryException { return new SimpleGroup (); }
        @Override
        public AssetType getSuperType () { 
            return PRINCIPAL;
        }        
	...
	public static final AssetType<LittleAcl> ACL  = new AssetType<LittleAcl> (
		...
		public LittleAcl create () throws FactoryException { return new SimpleAccessList (); }

		public AssetSpecializer getSpecializer () { return getAclManager (); }
        public boolean isNameUnique () { return true; }
	};
	...
	public static final AssetType<Quota> QUOTA    = new AssetType<Quota> (
		...
		public AssetSpecializer getSpecializer () { return getAccountManager (); }
		/** Return a LittleGroup implementation */
		public Quota create () throws FactoryException { return new SimpleQuota (); }
		public boolean mustBeAdminToCreate () { return true; }
	};
