...
public abstract class PackageTestSuite {
    ...
    public static Test suite () {
		...
		try {
            ...
            log_generic.log ( Level.SEVERE, "Failed to setup test suite, caught: " + e + ", " +
    ...
    private static void createAndShowGUI () {
		...
		try {
			...
			LoginContext login_context = new LoginContext ( "littleware.security.simplelogin",
													  new SimpleNamePasswordCallbackHandler ( w_password.getName (), w_password.getPass () )
													  );
			login_context.login ();
			
			Subject subject_user = login_context.getSubject ();
			PrivilegedAction<Object> act_run = new PrivilegedAction<Object> () {
				private String[] ov_launch_args = { "-noloading",
					"littleware.test.PackageTestSuite" 
				};
			...
			log_generic.log ( Level.WARNING, "Caught unexpected: " + e + ", " + 
