...
public class AddressBookTester extends TestCase {
	...
	private final LittleUser         ouser_test;
     ...
     * Inject dependencies.
     *
     * @param user_test to manipulate AddressBook data for
	 */
	public AddressBookTester ( String             s_test_name,
                               AssetManager       m_asset,
                               AssetSearchManager m_search,
                               LittleUser         user_test
                               ) {
		super( s_test_name );
        om_asset = m_asset;
        om_search = m_search;
        ouser_test = user_test;
	...
	public void tearDown () {
		try {
			UUID  u_contact = om_search.getAssetIdsFrom ( ouser_test.getObjectId (),
														  AddressAssetType.CONTACT 
														  ).get ( os_test_name );
			if ( null != u_contact ) {
	...
	public void testAddressBook () {
		try {
			...
			contact_test.setFromId ( ouser_test.getObjectId () );
			contact_test.setHomeId ( ouser_test.getHomeId () );
