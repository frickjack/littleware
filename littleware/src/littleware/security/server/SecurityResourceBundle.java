...
/**
    ...
    public enum Content {
        ...
        AccountManager, AclManager, SessionManager, AccountServiceProvider, AclServiceProvider;
    ...
    static {
        ...
        PrivilegedAction x_action = new GetGuardedResourceAction(SqlResourceBundle.getBundle(), SqlResourceBundle.Content.LittlewareConnectionFactory.toString());
        ...
        Content.AccountServiceProvider.set(new AbstractServiceProviderFactory<AccountManager>(ServiceType.ACCOUNT_MANAGER, m_searcher) {
            ...
            public AccountManager createServiceProvider(SessionHelper m_helper) throws BaseException, AssetException, GeneralSecurityException, RemoteException {
                AccountManager m_proxy = checkAccessMakeProxy(m_helper, false, om_account);
                return new RmiAccountManager(m_proxy);
            }
        });
        Content.AclServiceProvider.set(new AbstractServiceProviderFactory<AclManager>(ServiceType.ACL_MANAGER, m_searcher) {
