...
public class SimpleMABuilder extends SimpleAssetBuilder implements MemberAlias.MABuilder {
    ...
    private static class SimpleMemberAlias extends SimpleAsset implements MemberAlias {
