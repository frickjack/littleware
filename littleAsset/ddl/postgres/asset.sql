...
GRANT SELECT, UPDATE ON seq_transaction_counter TO GROUP littleware_user_group;
...
GRANT SELECT, UPDATE ON littleTran TO littleware_user_group;
...
GRANT SELECT ON x_permission TO GROUP littleware_user_group;
...
INSERT INTO x_asset_type (s_id, s_name, s_comment, b_name_unique)
    VALUES ( 'A7E11221546949FAAF1E8FCC52190F1D', 'littleware.principal', 'lw_principal.principal base class', false );
...
INSERT INTO x_asset_type (s_id, s_name, s_comment, b_name_unique, x_parent_type)
    VALUES ( 'FAA894CEC15B49CF8F8EC5C280062776', 'littleware.group', 'lw_principal.principal group',
              false, 'A7E11221546949FAAF1E8FCC52190F1D'  );

INSERT INTO x_asset_type (s_id, s_name, s_comment, b_name_unique)
    VALUES ( '04E11B112526462F91152DFFB51D21C9', 'littleware.acl', 'littleware.acl asset', false );
...
-- x_asset_type.
--
CREATE OR REPLACE FUNCTION rebuildAssetTypeTree()
...
CREATE TABLE asset (	
	...
	l_last_transaction  BIGINT NOT NULL DEFAULT nextval( 'seq_transaction_counter' ),
	s_pk_type           VARCHAR(32) REFERENCES x_asset_type( s_id ) NOT NULL,
...
GRANT SELECT, UPDATE ON asset_attr_i_id_seq TO GROUP littleware_user_group;
...
GRANT SELECT, UPDATE ON asset_link_i_id_seq TO GROUP littleware_user_group;
...
GRANT SELECT, UPDATE ON asset_date_i_id_seq TO GROUP littleware_user_group;
