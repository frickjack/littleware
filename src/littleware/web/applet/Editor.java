...
public class Editor extends JApplet {
    ...
    public void buildUI () {
		...
		try {
			...
			SessionManager m_session = SessionUtil.getSessionManager ( url_codebase.getHost (), 
            ...
            IconLibrary           lib_icon = new WebIconLibrary ( url_codebase.getHost () );
            ...
            AssetEditor           w_editor = (AssetEditor)
                factory_editor.createView ( lib_asset.retrieveAssetModel ( u_asset, m_search ) );
