...
<xsl:template match="/">
 ...
 <head>
   ...
   <script language="JavaScript" src="{$lw_doc_root}/js/lwUtil.js"></script>
   <script language="JavaScript" src="{$lw_doc_root}/js/lwApplet.js"></script>
