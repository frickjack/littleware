...
class SessionHelperProxy implements SessionHelper {
	private static Logger  olog_generic = Logger.getLogger ( "littleware.security.auth.SessionHelperProxy" );
		...
		GeneralSecurityException, RemoteException
	{
		...
		return (T) Proxy.newProxyInstance ( class_service.getClassLoader (),
