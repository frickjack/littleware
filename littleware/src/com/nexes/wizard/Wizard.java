...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
    private static final Logger olog_generic = Logger.getLogger ( "com.nexes.wizard.Wizard" );
    ...
    public void registerWizardPanel(Object id, WizardPanelDescriptor panel) {
        ...
        cardPanel.add(panel.getPanelComponent(), id.toString () );
   ...
   /**
    ...
    private static Object getImage(String name) {
        ...
        try {
            ...
            olog_generic.log( Level.WARNING, "Unable to find Wizard class");
        }
        return url;
    ...
    static {
        ...
        try { 
            ...
            olog_generic.log ( Level.WARNING, "Failed to load wizard resources, caught: " + e );
            BACK_TEXT = "Back";
            NEXT_TEXT = "Next";
            CANCEL_TEXT = "Cancel";
            FINISH_TEXT = "Finish";
