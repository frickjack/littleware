...
public class WizardModel {
    ...
    private final Map<String,Icon>                  buttonIconMap = new HashMap<String,Icon> ();
    private final Map<String,Boolean>               buttonEnabledMap = new HashMap<String,Boolean> ();
    {
        String[] v_buttonprops = {
            CANCEL_BUTTON_ENABLED_PROPERTY,
            NEXT_FINISH_BUTTON_ENABLED_PROPERTY,
            BACK_BUTTON_ENABLED_PROPERTY
        };
        for ( String s_prop : v_buttonprops ) {
            buttonEnabledMap.put ( s_prop, Boolean.FALSE );
        }
    }
     ...
     */    
     boolean setCurrentPanel(Object id) {
        ...
        WizardPanelDescriptor nextPanel =
            (WizardPanelDescriptor)panelMap.get(id);
    ...
    Icon getBackButtonIcon() {
        return (Icon)buttonIconMap.get(BACK_BUTTON_ICON_PROPERTY);
    }
    ...
    void setBackButtonIcon(Icon newIcon) {
        ...
        if (!newIcon.equals(oldIcon)) {
            buttonIconMap.put(BACK_BUTTON_ICON_PROPERTY, newIcon);
            firePropertyChange(BACK_BUTTON_ICON_PROPERTY, oldIcon, newIcon);
        }
    }

    Icon getNextFinishButtonIcon() {
        return (Icon)buttonIconMap.get(NEXT_FINISH_BUTTON_ICON_PROPERTY);
    }
    ...
    public void setNextFinishButtonIcon(Icon newIcon) {
        ...
        if (!newIcon.equals(oldIcon)) {
            buttonIconMap.put(NEXT_FINISH_BUTTON_ICON_PROPERTY, newIcon);
            firePropertyChange(NEXT_FINISH_BUTTON_ICON_PROPERTY, oldIcon, newIcon);
        }
    }

    Icon getCancelButtonIcon() {
        return (Icon)buttonIconMap.get(CANCEL_BUTTON_ICON_PROPERTY);
    }
    ...
    void setCancelButtonIcon(Icon newIcon) {
        ...
        if (!newIcon.equals(oldIcon)) {
            buttonIconMap.put(CANCEL_BUTTON_ICON_PROPERTY, newIcon);
