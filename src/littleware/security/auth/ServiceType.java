...
public abstract class ServiceType<T extends Remote> extends DynamicEnum<ServiceType> implements ServiceProviderFactory<T> { 	
	...
	public static Set<ServiceType> getMembers () { return getMembers ( ServiceType.class ); }
	 ...
	 */
	public Sampler getCallSampler () { return ostat_call; }
														 ...
														 )
	{
        ...
        public Class<AssetManager> getServiceInterface () { return AssetManager.class; }	
	};
						  ...
						  )
	{
        ...
        public Class<AssetSearchManager> getServiceInterface () { return AssetSearchManager.class; }	
											  ...
											  )
	{
        ...
        public Class<SessionHelper> getServiceInterface () { return SessionHelper.class; }	
	};
										...
										)
	{
        ...
        public Class<AccountManager> getServiceInterface () { return AccountManager.class; }	
										  ...
										  )
	{
        ...
        public Class<AclManager> getServiceInterface () { return AclManager.class; }	
