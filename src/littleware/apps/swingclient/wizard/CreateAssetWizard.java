...
public class CreateAssetWizard extends WizardAssetEditor {
    ...
    private final   ResourceBundle       obundle_labels = 
        ResourceBundle.getBundle ( "littleware.apps.swingclient.wizard.resources.WizardSupport" );
    ...
    private void initializePanels ( List<AssetType>  v_types ) {
        ...
        this.registerWizardPanel ( BasicPanel.PickType,
                                   new AssetTypePanelDescriptor ( BasicPanel.PickType,
                                       ...
                                       public BasicPanel getNextPanelDescriptor () { return BasicPanel.PickName; }
        ...
        this.registerWizardPanel ( BasicPanel.PickName,
                                   new WizardPanelDescriptor ( BasicPanel.PickName,
                                       ...
                                       public BasicPanel getBackPanelDescriptor () { return BasicPanel.PickType; }
                                       public Object getNextPanelDescriptor () { return BasicPanel.PickAcl; }
                                       public void aboutToDisplayPanel () {
        ...
        this.registerWizardPanel ( BasicPanel.PickAcl,
                                   new AssetPathPanelDescriptor ( BasicPanel.PickAcl,
                                       ...
                                       public BasicPanel getBackPanelDescriptor () { return BasicPanel.PickName; }
                                       public Object getNextPanelDescriptor () { return BasicPanel.PickFrom; }
        ...
        this.registerWizardPanel ( BasicPanel.PickFrom,
                                   new AssetPathPanelDescriptor ( BasicPanel.PickFrom,
                                       ...
                                       public BasicPanel getBackPanelDescriptor () { return BasicPanel.PickAcl; }
                                       public Object getNextPanelDescriptor () { return BasicPanel.PickTo; }
                                       public UUID getAssetId () {
        ...
        this.registerWizardPanel ( BasicPanel.PickTo,
                                   new AssetPathPanelDescriptor ( BasicPanel.PickTo,
                                       ...
                                       public BasicPanel getBackPanelDescriptor () { return BasicPanel.PickFrom; }
                                       public Object getNextPanelDescriptor () { return BasicPanel.PickComment; }
                                       public UUID getAssetId () {
        ...
        this.registerWizardPanel ( BasicPanel.PickComment,
                                   new WizardPanelDescriptor ( BasicPanel.PickComment,
                                       ...
                                       public BasicPanel getBackPanelDescriptor () { return BasicPanel.PickTo; }
                                       public Object getNextPanelDescriptor () { return WizardPanelDescriptor.FINISH; }
                                       public void aboutToDisplayPanel () {
