...
GRANT SELECT ON littleware.x_permission TO littleware_user;
...
GRANT SELECT ON littleware.x_asset_type TO littleware_user;
...
GRANT SELECT ON littleware.x_asset_type_tree TO littleware_user;
...
--
delimiter //
CREATE PROCEDURE littleware.rebuildAssetTypeTree()
    BEGIN
...
CALL littleware.rebuildAssetTypeTree();
...
GRANT SELECT, UPDATE, INSERT, DELETE ON littleware.asset TO littleware_user;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON littleware.asset_history TO littleware_user;
...
GRANT SELECT ON littleware.x_cache_status TO littleware_user;
...
CREATE TABLE littleware.client_cache (
    ...
    i_status            INTEGER NOT NULL REFERENCES littleware.x_cache_status( i_id ),
...
GRANT SELECT, INSERT, UPDATE, DELETE ON littleware.client_cache TO littleware_user;
